...
**multi-agent-shogun** （[GitHub: yohey-w/multi-agent-shogun](https://github.com/yohey-w/multi-agent-shogun)）は、おしおさん（yohey-w）が作成・公開しているOSSのマルチエージェントフレームワークです。筆者はこのリポジトリをforkして運用しています。
